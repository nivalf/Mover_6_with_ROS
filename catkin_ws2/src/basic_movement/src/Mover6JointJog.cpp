...
float joint1_demand, joint2_demand, joint3_demand, joint4_demand, joint5_demand, joint6_demand;
bool know_states;
...
void jointsDemandCallback(const std_msgs::Float32MultiArray::ConstPtr& msg) {
	...
	ROS_INFO("Received Demand %f\t%f\t%f\t%f\t%f\t%f", joint1_demand, joint2_demand, joint3_demand, joint4_demand, joint5_demand, joint6_demand);
}
...
int main(int argc, char **argv) {
	...
	ros::Subscriber chatter_sub2 = n.subscribe("/joint_demands", 1000, jointsDemandCallback);
	...
	while(ros::ok()) {
		if(know_states && demand_received) {
